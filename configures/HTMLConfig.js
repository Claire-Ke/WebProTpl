...
let htmlWebpackPluginA_arr = [
    ...
    new htmlWebpackPlugin( {
        // [sha512:contenthash:hex:8]
        filename: 'pages/DaMeng.html',
        template: './src/tplEJS/pages/DaMeng.ejs',
        title: '达蒙面试Demo',
        /**
         * 多页面应用时，用于该页面对应的.js文件的路由处理，表示这个页面只导入"src/js/App.js"中所配置的这个页面对应的.js
         */
        ...
        data: {
            /*
             ...
             都在src/tplEJS/basic/metaLink下
             */
            metaLinkName_str: 'DaMeng',
            // 配置meta、link的信息
            metaLinkData: {
                keywords: '达蒙',
                description: '达蒙面试Demo',
                subject: '达蒙面试Demo',
                appTitle: '达蒙面试Demo',
                appName: '达蒙面试Demo',
                color: '#525973',
