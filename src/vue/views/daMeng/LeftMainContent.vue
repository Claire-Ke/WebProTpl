...
<style lang = 'scss'
       scoped
       src = '../../styles/daMeng/LeftMainContent.scss' />
<template>
    <div class = 'css-reset root'>
        <section class = 'css-reset cardsBox'></section>
        <section class = 'css-reset mainServicesBox'></section>
        <section class = 'css-reset dataBox'></section>
    </div>
</template>
<script type = 'module'>
    'use strict';
